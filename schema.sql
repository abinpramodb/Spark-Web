...
INSERT OR IGNORE INTO templates (id, name, category, description, thumbnail, demoPath, price) VALUES
...
('template-4', 'Nova SaaS Landing Page Pro', 'saas', 'High-performance SaaS landing page with dark glassmorphism layout, modular grids, pricing calculator, and clean flex layouts.', 'https://images.unsplash.com/photo-1551434678-e076c223a692?auto=format&fit=crop&w=800&q=80', 'template-1', '$14.99');
