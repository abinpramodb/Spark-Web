...
function Pricing() {
  return (
    <section id="pricing" className="py-24 lg:py-32" style={{ background: "#0d0d0d" }}>
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p
            ...
            style={{ color: "#888880", fontFamily: "Outfit, sans-serif" }}
          >
            Fixed-price projects with milestone-based payments. You always know what you are getting and what it costs before we start.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
          {plans.map((plan) => (
            <div
              key={plan.name}
              className="relative rounded-sm p-8 flex flex-col border transition-all duration-300 hover:-translate-y-1"
              style={{
                background: plan.highlight ? "rgba(200,255,0,0.05)" : "#131313",
                borderColor: plan.highlight ? "rgba(200,255,0,0.4)" : "rgba(255,255,255,0.06)",
              }}
            >
              {plan.highlight && (
                <div
                  className="absolute -top-px left-1/2 -translate-x-1/2 px-4 py-1 text-xs font-semibold rounded-b-sm"
                  style={{ background: "#c8ff00", color: "#0a0a0a", fontFamily: "JetBrains Mono, monospace" }}
                >
                  MOST POPULAR
                </div>
              ...
              <div className="flex items-baseline gap-1.5 mb-2">
                ...
                <span className="text-sm" style={{ color: "#888880", fontFamily: "Outfit, sans-serif" }}>
                  / {plan.period}
                </span>
              </div>
              <p
                className="text-sm mb-8 pb-8 border-b leading-relaxed"
                style={{ color: "#888880", fontFamily: "Outfit, sans-serif", borderColor: "rgba(255,255,255,0.06)" }}
              >
                {plan.desc}
              </p>
              ...
              <ul className="flex-1 flex flex-col gap-3 mb-8">
                {plan.features.map((f) => (
                  <li key={f} className="flex items-start gap-3 text-sm" style={{ color: "#c0c0bc", fontFamily: "Outfit, sans-serif" }}>
                    <Check
                      size={14}
                      className="mt-0.5 shrink-0"
                      style={{ color: plan.highlight ? "#c8ff00" : "#666660" }}
                    />
                    {f}
                  </li>
                ))}
              ...
              <a
                href="#contact"
                className="text-center py-3.5 text-sm font-semibold rounded-sm border transition-all duration-200 hover:opacity-90 active:scale-95"
                style={
                  plan.highlight
                    ? { background: "#c8ff00", color: "#0a0a0a", borderColor: "#c8ff00", fontFamily: "Outfit, sans-serif" }
                    : { background: "transparent", color: "#f0f0ee", borderColor: "rgba(255,255,255,0.12)", fontFamily: "Outfit, sans-serif" }
                }
              >
                {plan.cta}
              </a>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
          {testimonials.map((t) => (
            <div
              key={t.name}
              className="p-8 rounded-sm border flex flex-col gap-6"
              style={{ background: "#131313", borderColor: "rgba(255,255,255,0.06)" }}
            >
              ...
              <p
                ...
                style={{ color: "#c0c0bc", fontFamily: "Outfit, sans-serif" }}
              >
                "{t.text}"
              </p>
...
function FAQ() {
  ...
  return (
    <section className="py-24 lg:py-32" style={{ background: "#0d0d0d" }}>
          ...
          {faqs.map((faq, i) => (
            <div key={i} style={{ background: "#0d0d0d" }}>
              <button
                ...
                className="w-full flex items-center justify-between px-6 py-5 text-left transition-colors hover:bg-white/[0.02] group"
              >
                <span
